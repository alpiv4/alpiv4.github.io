...
- [ ] implement a safe pocket mechanic, where one can upgrade their backpack to extract more items with higher upgrades like in arc raiders

- [ ] Check the gridmap starter template [https://docs.godotengine.org/en/stable/tutorials/3d/using_gridmaps.html](https://docs.godotengine.org/en/stable/tutorials/3d/using_gridmaps.html)
...
- [ ] Watch this old dungeon generator video you watched before again. It also uses normalmaps, u can learn something [https://www.youtube.com/watch?v=VjuyfBaryu8](https://www.youtube.com/watch?v=VjuyfBaryu8)
