...
- coop (helping, being faster or smarter and then help out)
- building (and defending, it has to have a use, bridges, towers, walls)
- progression (understanding mechanics and upgrading, unlocking)
...
Idea
Coop game, every player has his own world and builds, farms and upgrades materials. Special materials are only in dungeons, so players need to cooperate. They combine both their attack power (items, units they can produce etc) and challenge a dungeon.
